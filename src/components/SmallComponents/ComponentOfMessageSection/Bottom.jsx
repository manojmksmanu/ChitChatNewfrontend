        ...
        <form>
          <div class=" relative flex items-center md:px-3  py-2 rounded-lg bg-gray-50 dark:bg-gray-700">
            ...
            {/* <textarea
              ...
              id="chat"
              rows="1"
              class="block md:mx-3 mx-0 p-2.5 w-full text-sm bg-transparent text-slate-800 dark:text-slate-100 border-none focus:no-underline focus:outline-none focus:border-none"
              placeholder="Your message..."
            /> */}
            <button
              type="submit"
