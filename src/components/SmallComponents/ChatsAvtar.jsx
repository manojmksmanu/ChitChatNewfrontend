...
const ChatsAvtar = ({ selected }) => {
  return (
    <div
      className={`flex md:w-full items-center gap-2 cursor-pointer md:p-3 p-2 relative dark:text-slate-50  ${
        selected === "style" ? "bg-blue-500 text-white" : ""
      }`}
    >
      <img
        className="md:w-8 w-6 md:h-8  h-6 rounded-full bg-white drop-shadow-lg p-1"
